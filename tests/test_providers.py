...
def test_apt_provider() -> None:
    ...
    with patch("rv.providers.apt.AptProvider.is_available", return_value=True), \
...
def test_flatpak_provider() -> None:
    ...
    with patch("rv.providers.flatpak.FlatpakProvider.is_available", return_value=True), \
...
def test_snap_provider() -> None:
    ...
    with patch("rv.providers.snap.SnapProvider.is_available", return_value=True), \
...
def test_docker_provider() -> None:
    ...
    with patch("rv.providers.docker.DockerProvider.is_available", return_value=True), \
